...
function panCurrLocation() {
    ...
    gMap.addListener('click', (mapsMouseEvent) => {
        ...
        // console.log('infoWindow.lat:', infoWindow.lat);
    });
}
...
function renderLocationInfo() {
    ...
    <td class = "remove" onclick="onRemoveLocation('${location.id}')"><i class="fas fa-trash"></i><button onclick="onPanLocation()">Go!</button></td>
    </tr>`;
